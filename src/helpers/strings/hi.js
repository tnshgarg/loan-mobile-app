...
export default {
  ...
  updatingMandate: "अधिदेश पंजीकरण विवरण अद्यतन कर रहा है",
  ...
  learnWithUs: "हमारे साथ जानें",
  getYouVerified: "चलिए आपको वेरिफ़ाई करवाते हैं",
  ...
  getInTouch:
    "प्रश्न हैं? कृपया संपर्क करें और हमें आपकी मदद करने में खुशी होगी",
  contactSupport: "संपर्क सहायता",
  explore: "अन्वेषण करें",
  loggingOut: "आपको लॉग आउट किया जा रहा है...",
  logout: "लॉग आउट",
  amountDue: "बकाया रकम",
  noInternet: "कोई इंटरनेट नहीं",
  checkInternetConnection: "कृपया अपने इंटरनेट कनेक्शन की जाँच करें",
  refresh: "रीफ़्रेश करें",
  rbiGuidelines:
    "आरबीआई के दिशानिर्देशों के अनुसार, आपको अग्रिम वेतन प्राप्त करने के लिए ई-केवाईसी पूरा करना होगा",

  rbiApprovedLendingPartners: "उधार देने वाले साझेदार आरबीआई द्वारा अनुमोदित",
