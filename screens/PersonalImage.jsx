...
export default PersonalImage = () => {
    ...
    const ProfilePush = () => {
      var profilePayload= GenerateDocument({"src":"Profile","id":"62be55b1bb8d55cb4644801b","maritalStatus":Profile["maritalStatus"],"qualification":Profile["qualification"],"altMobile":Profile["altMobile"],"email":Profile["email"],"photo":imageData});
  ...
  return (
    <>
     ...
     <ScrollView keyboardShouldPersistTaps='handled'>
        ...
        <IconButton icon={<Icon name="image-search" size={30} color="black"/>} style={selfie.uploadButton} onPress={()=>{onImageLibraryPress()}}/>
        <IconButton icon={<Icon name="camera-alt" size={25} color="black"/>} style={selfie.cameraButton} onPress={()=>{onCameraPress()}}/>
        </View>
      <Button title="Finish" type="solid"  uppercase={false} style={form.nextButton} color="#4E46F1" onPress={()=>{ProfilePush()}}/>
